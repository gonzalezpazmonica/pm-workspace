...
| 8.3 | ~~SPEC-130~~ | ~~Conformidad SKILL.md~~ — **ABORTED 2026-05-23** (premisa falsa: skills NO superan 150 líneas por Rule #11) | — |
...
| 8.8 | ~~SPEC-135~~ | ~~SKILL.md progressive disclosure split~~ — **ABORTED 2026-05-23** (sin caso real, depende de SPEC-130) | — |
...
| 8.10 | SPEC-137 | Hooks multi-handler — plugin TS para LLM judges + MCP audit + HTTP via fetch | L (35h, recalibrado 2026-05-23) |
...
- ~~SPEC-130 ← SPEC-135~~ (ambos ABORTED)
...
**Bucket Q2 efectivo tras review 2026-05-23**: 6 specs (128, 129, 131, 132, 133, 134). 130 y 135 ABORTED. Ver `output/SPEC-128-140-review-20260523.md` para detalle.
