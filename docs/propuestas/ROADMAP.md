...
| 8.2 | SPEC-142 | Plugin `tool.execute.before` para auto-redaction de secrets (TS, mutación args) — **IMPLEMENTED 2026-05-23** (Slices 1+2) | S (5h) |
...
| 8.7 | SPEC-147 | Decision trees para top-10 agentes (1/10 → 10/10) — 🟡 IN_PROGRESS 2026-05-23 (Slice 1: 4/10 trees) | M (10h) |
