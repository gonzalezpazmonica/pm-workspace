...
══════════════════════════════════════════════════
  ...
  Burndown (SP)
  Ideal:  ▓▓▓▓▓▓▓░░░░░░░░░░░░░  38 → 0
  Real:   ▓▓▓▓▓▓▓▓▓░░░░░░░░░░░  38 → 23 completados  WARN
  → Lleváis 15 SP completados, deberían ser 15.2 → OK en línea

  En progreso (5 items):
    AB#2041  POST /citas endpoint           Laura S.    [4/6h] OK en plazo
    AB#2042  CitaValidator FluentValidation   agente   [terminado, en review]
    AB#2043  Unit tests CitaService          agente   [en ejecución, 2h]
    AB#2044  Migración tabla Citas          Carlos TL   [0/4h] FAIL sin avance
    AB#2045  GET /citas?fecha query         Diego T.    [2/4h] OK
  ...
  Estimación de cierre: WARN RIESGO MODERADO — depende de la migración
```
...
══════════════════════════════════════════
  ...
  └──────┴────────────────────────────────────┴─────┴────────┘
  Propuesta: #301 + #302 + #304 + #305 = 18 SP / 84h OK dentro de capacity
...
Resumen de asignación:
  Carlos TL:  22h (54% capacity) OK
  Laura S.:   18h (32% capacity) WARN tiene margen, ¿añadir #303 parcialmente?
  Diego T.:   24h (47% capacity) OK
  Ana QA:     20h (35% capacity) OK
...
OK Informe generado: output/reports/GestionClinica-horas-2026-04.xlsx
...
Resumen ejecutivo:
  ...
  Por persona:
    ...
    Diego T.    → 52.0h / 50.6h (103%) WARN +2.4h sobre capacity
    Ana QA      → 52.8h / 56.3h (94%) OK

  Items completados: 9/11 (18/20 SP — velocity 18 vs histórico 38 FAIL)
...
Carga del equipo — semana actual (lun 17/03 – vie 21/03)
  ...
  Carlos TL    ██████████░░░░░  68%  [ 20.4h / 30h disponibles ]  OK
  Laura S.     █████████████░░  87%  [ 32.8h / 37.5h ]            WARN alta
  Diego T.     ████████████████ 100% [ 37.5h / 37.5h ]            FAIL sin margen
  Ana QA       ████████░░░░░░░  55%  [ 20.6h / 37.5h ]            OK tiene margen
   Agente    ███████░░░░░░░░  48%  [ 3 specs en cola ]          OK

  WARN  Diego Torres está al 100% — no absorbe incidencias ni bugs inesperados.
...
Creando 8 tasks en Azure DevOps para AB#302...
  OK AB#302-B1 creada → asignada a Carlos Mendoza
  OK AB#302-B2 creada → asignada a Diego Torres
  OK AB#302-B3 creada → asignada a claude-agent (tag: spec-driven)
  OK AB#302-C1 creada → asignada a claude-agent (tag: spec-driven)
  OK AB#302-C2 creada → asignada a claude-agent (tag: spec-driven)
  OK AB#302-D1 creada → asignada a claude-agent-fast (tag: spec-driven)
  OK AB#302-D2 creada → asignada a Ana Morales
