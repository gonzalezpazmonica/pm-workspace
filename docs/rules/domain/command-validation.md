...
- Contexto total real (depende de qué reglas `@` cargue el AI coding assistant en la sesión)
...
Si el AI coding assistant carga además muchas reglas `@`, el prompt puede excederse aun así.
