...
- **Installation**: Claude Code / OpenCode + pm-workspace CLI on each dev's laptop
...
- **Agents/Skills**: Python + YAML. Works in Cursor, VS Code, Claude Code / OpenCode, offline.
...
# Result:
# - Claude Code / OpenCode + pm-workspace CLI ready
