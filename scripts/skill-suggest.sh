...
declare -A DISPATCH_TABLE=(
  ...
  ["cupula|cúpula|context dome|dome|vaults|vault|savia vaults|savia-vaults|federate dome|federar cupula|confidencialidad vault|backup cupula|backup dome|backup vaults"]="savia-vaults"
