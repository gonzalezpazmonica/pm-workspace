...
check_contains "CLAUDE.md" "136 slash commands" "CLAUDE.md"

echo ""
echo "📖 Integración con README.md"
check_contains "README.md" "/update" "README.md"
check_contains "README.md" "136 comandos" "README.md"

echo ""
echo "📖 Integración con README.en.md"
check_contains "README.en.md" "/update" "README.en.md"
check_contains "README.en.md" "136 commands" "README.en.md"
