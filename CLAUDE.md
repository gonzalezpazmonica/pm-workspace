...
`.claude/{agents(70), commands(560), profiles, hooks(73/75reg), rules/{domain,languages}, skills(99), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
73 hooks (75 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
