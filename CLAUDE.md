...
`.claude/{agents(81), commands(562), profiles, hooks(99/107reg), rules/{domain,languages}, skills(119), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
99 hooks (107 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
