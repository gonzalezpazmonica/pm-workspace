...
`.claude/{agents(81), commands(563), profiles, hooks(100/107reg), rules/{domain,languages}, skills(119), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
100 hooks (107 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
