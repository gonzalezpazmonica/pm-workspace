...
`.claude/{agents(83), commands(570), profiles, hooks(109/112reg), rules/{domain,languages}, skills(126), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
103 hooks (112 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
