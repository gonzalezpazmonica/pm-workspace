...
`.claude/{agents(81), commands(562), profiles, hooks(98/103reg), rules/{domain,languages}, skills(105), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
98 hooks (103 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
