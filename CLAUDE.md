...
`.claude/{agents(88), commands(571), profiles, hooks(116/119reg), rules/{domain,languages}, skills(131), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
115 hooks (116 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
