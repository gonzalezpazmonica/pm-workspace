...
`.claude/{agents(72), commands(561), profiles, hooks(75/78reg), rules/{domain,languages}, skills(102), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
| Catálogo 72 agentes | `docs/rules/domain/agents-catalog.md` | Selección de agente para una tarea |
