...
`.claude/{agents(83), commands(570), profiles, hooks(110/113reg), rules/{domain,languages}, skills(126), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
104 hooks (113 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
