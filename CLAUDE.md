...
`.claude/{agents(75), commands(562), profiles, hooks(83/86reg), rules/{domain,languages}, skills(104), settings.json}` · `docs/` · `projects/` · `scripts/` · `tests/`
...
83 hooks (86 registrados) en `.claude/settings.json` — arranque blindado (sin red, sin deps externas).
