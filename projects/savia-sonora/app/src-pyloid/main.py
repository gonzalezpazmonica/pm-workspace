...
def ensure_single_instance():
    ...
    try:
        ...
        mutex_name = "SaviaTranscriptor_SingleInstance_Mutex"

        _instance_mutex = kernel32.CreateMutexW(None, False, mutex_name)

        if kernel32.GetLastError() == ERROR_ALREADY_EXISTS:
            log.warning("Another instance of Savia Transcriptor is already running")
...
app = Pyloid(app_name="savia-transcriptor", single_instance=True, server=server)
