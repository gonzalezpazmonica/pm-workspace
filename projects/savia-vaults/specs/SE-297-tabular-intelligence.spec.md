# Spec: SE-297 — Tabular Intelligence: soporte Excel, deteccion relacional y correccion de citas
...
| Fichero | Proposito |
|---|---|
| `projects/savia-vaults/specs/SE-297-tabular-intelligence.spec.md` | Esta spec |
| `tests/bats/test-se297-tabular-excel.bats` | BATS tests (AC-1.x, AC-2.x) |
...
| `CHANGELOG.d/se297-tabular-intelligence.md` | Entrada de correccion documental (AC-3.2) |
