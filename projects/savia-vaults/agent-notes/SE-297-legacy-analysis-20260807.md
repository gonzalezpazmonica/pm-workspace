# SE-297 — Legacy Analysis: Tabular Intelligence gaps

> Agent note — 2026-08-07 · Analyst: Savia · Spec: `SE-297-tabular-intelligence.spec.md`
...
- BATS nuevos `tests/bats/test-se297-tabular-excel.bats` (AC-1.1..1.4, AC-2.1..2.4).
