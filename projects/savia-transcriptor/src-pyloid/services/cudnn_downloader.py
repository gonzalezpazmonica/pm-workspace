...
On Windows: Downloads cuDNN and cuBLAS DLLs from NVIDIA's public CDN to ~/.savia/transcriptor/cuda/
...
from services.paths import cuda_dir as cuda_dir_path
