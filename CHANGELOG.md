...
Re-sign confidentiality after missed signatures in PRs #364-#365.

### Fixed

- **Confidentiality**: re-signed `.confidentiality-signature` to match current main
- **Lesson**: added to `tasks/lessons.md` — ALWAYS sign before push, even docs-only PRs
